...
def backwarp(tenIn, tenflow):
    ...
    return torch.nn.functional.grid_sample(input=tenIn, grid=(backwarp_tenGrid[str(tenflow.shape)] + tenflow).permute(0, 2, 3, 1).to(tenIn.dtype), mode='bilinear', padding_mode='zeros', align_corners=True)
